...
- 🏏 **Jos Buttler** led the match-level high-score analysis with **651** cumulative runs, followed by **Quinton de Kock** with **377**
  *(Note: this 651 is based on my match-level dataset calculation, not the official IPL season aggregate of 863 runs — just flagging that difference.)*
...
4. Launch Jupyter Notebook
   ...
   jupyter notebook
   ```
5. Open `IPL 2022_Capstone_project.ipynb`
...
Full analysis and visualizations here: [IPL 2022 Capstone Project Notebook](https://github.com/mo-anas561/IPL_2022_Analysis/blob/main/IPL%202022_Capstone_project.ipynb)

## 👨‍💻 Author

**Mo Anas**
GitHub: [@mo-anas561](https://github.com/mo-anas561)
